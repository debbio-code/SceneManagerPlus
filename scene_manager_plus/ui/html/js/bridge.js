...
window.SMBridge = (function () {
  ...
  return {
    ...
    openVariant:     function (id)    { call('sm_open_variant', { id: id }); },
    copyVariant:     function (id)    { call('sm_variant_copy', { id: id }); },
    pasteVariant:    function (id)    { call('sm_variant_paste', { id: id }); },
    printScaleApply: function (id)    { call('sm_print_scale_apply', { id: id }); },
    printScaleEdit:  function (id)    { call('sm_print_scale_edit', { id: id }); },
    printScaleClear: function (id)    { call('sm_print_scale_clear', { id: id }); },
